...
format_name = 'PDF'
#parameters = (\
#    ('box','choice',0,('Page','Bounding box'),'Export area'), \
#    ('images','choice',0,('Automatic','Lossless'),'Image compression'))
#unload = 1
#preopen_output = 0
###End
...
def save(document, file, filename, options = {}):
    ...
    ps = PostScriptDevice(file, document = document, as_eps = 1, embed_fonts = 1,
                          bounding_box = bbox,
